    ...
    class D3Image
    {
        ...
        */
        function D3Image($CssCodes)
        {
            ...
            if (isset($Css['file']) &&  is_file($Css['file']))
            {
                $this->Load($Css['file']);
            } 
            else 
        ...
        */
        public function Crop($w, $h, $StartX = 0, $StartY = 0)
        {
            ...
            imagecopyresampled($Img->image, $this->image, 0, 0, $StartX, $StartY, $w, $h, $w, $h);
            $this->height = $h;
            $this->width  = $w;
            $this->Destroy();
        ...
        */
        function Resize($widthAndHeightCss)
        {
            ...
            elseif ($Css['height']>0)
            {
                $this->resizeByHeight($Css['height']);
            }
            else
            {
        ...
        * @return D3Image
        */
        public function SaveToFile($FileName,$outputFunc = false)
        {
            ...
            if($outputFunc)
            {
               @$outputFunc($this->image,$FileName);
            }
            else
            {
                if (!$this->RunEvent($this->OutputFunc, $Array))
                {
                    $this->Error('Error While Saving To File : '.$FileName);
                }
            }
